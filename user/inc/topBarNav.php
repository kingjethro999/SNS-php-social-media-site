...
<nav class="main-header navbar navbar-expand-lg navbar-light bg-gradient-light border-bottom border-4 shadow">
  <div class="container-fluid px-4 px-lg-5">
    ...
    <!-- Search Form -->
    <div id="search-form-folder" class="w-25 position-relative d-none d-lg-block">
      <form action="" id="search-form">
        <div class="input-group input-group-sm">
          <input class="form-control form-control-sm rounded-0" name="search" id="search" type="search" placeholder="Search">
